...
a persistence unit "OrganizationPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/com/itlsco/pocs/organization/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Organization/pom.xml":
...
artifacts ("Organization-ejb.jar" and "Organization-web.war") are already built. You can build
